...
namespace MuffinDev
{
    ...
    ///<summary>
    /// Extensions for UnityEngine.Vector2Int struct.
    ///</summary>
    public static class Vector2IntExtension
	{
        ...
        /// <param name="_Min">The minimum value of the x and y components of the given vector.</param>
        ...
        /// </summary>
        /// <param name="_Vector">The input vector to compute.</param>
        /// <param name="_Max">The maximum value of the x and y components of the given vector.</param>
        /// <returns>Returns the computed vector.</returns>
